...
class RandomSineJointPositionCommand(CommandTerm):
    ...
    def __init__(self, cfg: "RandomSineJointPositionCommandCfg", env: "ManagerBasedRlEnv"):
        ...
        joint_ids, _ = self.robot.find_joints(cfg.joint_names, preserve_order=True)
    ...
    def _update_command(self) -> None:
        ...
        # Smooth "warm start" ramp so commands start at 0 with zero velocity/acceleration.
...
class RandomSineJointPositionCommandCfg(CommandTermCfg):
    ...
    phase_range: tuple[float, float] = (-3.14159, 3.14159)
    ramp_time: float = 0.5
